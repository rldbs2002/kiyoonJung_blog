...
date: 2024-01-12
description: Next.js를 사용하여 블로그 만들기
...
- [데모 페이지](https://build-own-blog-with-next-js.vercel.app)
...
> Tip! 아직 베타단계인 라이브러리라서 [Who is using Contentlayer?](https://github.com/contentlayerdev/contentlayer#who-is-using-contentlayer) 초반에 블로그 이름 올릴 수 있음
...
```md:posts/first.mdx
---
title: kiyoonjung의 Next.js 블로그 만들기
date: 2024-01-10
